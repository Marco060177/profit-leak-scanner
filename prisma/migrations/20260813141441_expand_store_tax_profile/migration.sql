...
INSERT INTO "new_StoreTaxProfile" ("countryCode", "createdAt", "defaultVatRatePct", "id", "regime", "shop", "updatedAt") SELECT "countryCode", "createdAt", "defaultVatRatePct", "id", "regime", "shop", "updatedAt" FROM "StoreTaxProfile";
