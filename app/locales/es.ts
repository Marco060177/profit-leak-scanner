export const es = {
  ...
  profitImpactPage: {
    eyebrow: "PROFIT IMPACT TRACKER", description: "Haz seguimiento de una acción desde su aceptación hasta su baseline inmutable y el periodo de medición.", growthRequired: "Profit Impact Tracker requiere Growth.", upgrade: "Ver el plan Growth", actionType: "Tipo de acción", priceChange: "Cambio de precio", cogsChange: "Cambio de COGS", productAction: "Acción sobre el producto", product: "Producto", title: "Título", descriptionLabel: "Descripción del cambio", previousValue: "Valor anterior", appliedValue: "Valor aplicado", targetValue: "Valor objetivo (opcional)", notes: "Notas (opcional)", trackAction: "Seguir esta acción", status: "Estado", markApplied: "Marcar como aplicada", empty: "Empieza desde Profit Action Center o Recovery Simulator para seguir una acción.", ACCEPTED: "Aceptada", AWAITING_APPLICATION: "Pendiente de aplicación", MEASURING: "En medición", COMPLETED: "Completada", CANCELLED: "Cancelada", INVALIDATED: "Invalidada", INSUFFICIENT_DATA: "Datos insuficientes", baseline: "Baseline", baselineProfit: "Beneficio económico baseline", baselineMargin: "Margen económico baseline", measurementProgress: "Progreso de la medición", daysObserved: "días observados", earlyResult: "Resultado inicial — la medición sigue en curso.", measuredChange: "Cambio medido", profitChange: "Cambio del beneficio económico", marginChange: "Cambio del margen", revenueChange: "Cambio de los ingresos", unitsChange: "Cambio de unidades", estimatedAttributableImpact: "Impacto atribuible estimado", dataConfidence: "Confianza de los datos", attributionConfidence: "Confianza de la atribución", methodology: "Metodología", reasons: "Motivos", insufficientExplanation: "La ventana final no contiene datos suficientemente fiables para estimar el resultado.",
  },
  taxProfilePage: {
    tax: "impuesto",
