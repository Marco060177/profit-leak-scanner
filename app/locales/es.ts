export const es = {
  ...
  billing: {
    ...
    starterFeatures: [
      [
        ...
        "Usa MarginLab en inglés, italiano, francés, alemán, español o portugués de Brasil.",
      ],
      [
    ...
    growthFeatures: [
      ...
      [
        ...
        "Mide qué cambió tras una acción de rentabilidad y estima su impacto con prudencia.",
      ],
      [
  ...
  supportPage: {
    ...
    errors: {
      ...
      missingTopic: "Selecciona un tema de soporte.",
      subjectTooShort: "Introduce un asunto de al menos 3 caracteres.",
      subjectTooLong: "El asunto es demasiado largo.",
      messageTooShort: "Describe el problema con al menos 10 caracteres.",
      messageTooLong: "El mensaje es demasiado largo.",
      sendFailed: "No se pudo enviar el mensaje. Inténtalo de nuevo en unos instantes.",
    },
    whatsappPrefill: "Hola, necesito ayuda con MarginLab.",
    sending: "Enviando...",
  ...
  profitImpactPage: {
    ...
    journeyTitle: "De la señal a la evidencia",
    journeyIntro:
      "Profit Impact cierra el ciclo de decisión de MarginLab convirtiendo una señal económica en evidencia de lo que cambió.",
    signalDetected: "Señal detectada",
    signalDetectedDescription:
      "MarginLab identifica un problema o una oportunidad de rentabilidad.",
    journeyAction: "Acción realizada",
    actionSelectedDescription:
      "La acción elegida se registra para medir qué sucede después.",
    ...
    measurementJourneyDescription:
      "MarginLab compara el rendimiento posterior con la referencia anterior.",
    journeyEvidence: "Evidencia creada",
    resultDescription:
      "El resultado muestra qué cambió y con qué prudencia puede asociarse ese cambio a la acción.",
  },
  taxProfilePage: {
    tax: "impuesto",
