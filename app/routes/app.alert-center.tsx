...
function getSeverityStyle(
  ...
  const styles: Record<ProfitAlertSeverity, StatusStyle> = {
    critical: {
      label: language === "it" ? "Critico" : language === "fr" ? "Critique" : language === "de" ? "Kritisch" : "Critical",
      color: "#ff6b4a",
    ...
    warning: {
      label: language === "it" ? "Attenzione" : language === "fr" ? "Avertissement" : language === "de" ? "Warnung" : "Warning",
      color: "#f59e0b",
    ...
    opportunity: {
      label: language === "it" ? "Opportunità" : language === "fr" ? "Opportunité" : language === "de" ? "Chance" : "Opportunity",
      color: "#22c55e",
    ...
    info: {
      label: language === "it" ? "Informazione" : language === "fr" ? "Information" : language === "de" ? "Information" : "Information",
      color: "#38bdf8",
...
function getAlertStatusStyle(
  ...
  const styles: Record<ProfitAlertStatus, StatusStyle> = {
    new: {
      label: language === "it" ? "Nuovo" : language === "fr" ? "Nouveau" : language === "de" ? "Neu" : "New",
      color: "#ff875f",
    ...
    active: {
      label: language === "it" ? "Attivo" : language === "fr" ? "Actif" : language === "de" ? "Aktiv" : "Active",
      color: "#38bdf8",
      background: "rgba(56,189,248,0.11)",
      border: "rgba(56,189,248,0.28)",
    },
    ...
    acknowledged: {
      label: language === "it" ? "Preso in carico" : language === "fr" ? "Pris en compte" : language === "de" ? "Zur Kenntnis genommen" : "Acknowledged",
      color: "#c084fc",
    ...
    resolved: {
      label: language === "it" ? "Risolto" : language === "fr" ? "Résolu" : language === "de" ? "Gelöst" : "Resolved",
      color: "#4ade80",
      background: "rgba(34,197,94,0.11)",
      border: "rgba(34,197,94,0.28)",
    },
...
function formatTimestamp(timestamp: string | undefined, language: Language) {
  if (!timestamp) {
    return language === "it" ? "Adesso" : language === "fr" ? "Maintenant" : language === "de" ? "Jetzt" : "Now";
  }
  ...
  if (differenceMinutes < 60) {
    return language === "it"
      ...
      : language === "fr" ? `il y a ${differenceMinutes} min` : language === "de" ? `vor ${differenceMinutes} Min.` : `${differenceMinutes} min ago`;
  }
  ...
  if (differenceHours < 24) {
    return language === "it"
      ...
      : language === "fr" ? `il y a ${differenceHours} h` : language === "de" ? `vor ${differenceHours} Std.` : `${differenceHours}h ago`;
  }

  const differenceDays = Math.floor(differenceHours / 24);

  if (differenceDays === 1) {
    return language === "it" ? "Ieri" : language === "fr" ? "Hier" : language === "de" ? "Gestern" : "Yesterday";
  }

  if (differenceDays < 7) {
    return language === "it"
      ? `${differenceDays} giorni fa`
      : language === "fr" ? `il y a ${differenceDays} jours` : language === "de" ? `vor ${differenceDays} Tagen` : `${differenceDays} days ago`;
  }
